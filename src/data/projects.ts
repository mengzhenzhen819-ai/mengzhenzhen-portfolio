...
export const projectsDetail: Project[] = [
  {
    ...
    duration: "历时6个月",
    highlight: "从0-1搭建",
    image: "/images/qiandao-detail-1.jpg",
    description: "从用户行为数据出发，重构签到核心流程与奖励感知，带动留存指标有效提升。",
    gallery: ["/images/qiandao-detail-2.jpg", "/images/qiandao-detail-3.jpg", "/images/qiandao-detail-4.jpg", "/images/qiandao-detail-5.jpg"],
    pdfUrl: "",
  },
  {
    id: "qiandao",
